...
%>
<tr><td><%=id%></td><td><%=result%></td><td><img src="mimage.jsp?id=<%=id%>" width="100px" height="50px"></td><td><a href="accept.jsp?id=<%=id%>"><%=approve%></a></td></tr>
...
%>
<tr><td><%=id2%></td><td><%=result2%></td><td><img src="mimage.jsp?id=<%=id2%>" width="100px" height="50px"></td><td><a href="accept.jsp?id=<%=id2%>"><%=approve%></a></td></tr>
...
%>
<tr><td><%=id3%></td><td><%=result3%></td><td><img src="mimage.jsp?id=<%=id3%>" width="100px" height="50px"></td><td><a href="accept.jsp?id=<%=id3%>"><%=approve%></a></td></tr>
...
%>
<tr><td><%=id4%></td><td><%=result4%></td><td><img src="mimage.jsp?id=<%=id4%>" width="100px" height="50px"></td><td><a href="accept.jsp?id=<%=id4%>"><%=approve%></a></td></tr>
...
%>
<tr><td><%=id5%></td><td><%=result5%></td><td><img src="mimage.jsp?id=<%=id5%>" width="100px" height="50px"></td><td><a href="accept.jsp?id=<%=id5%>"><%=approve%></a></td></tr>
...
%>
<tr><td><%=id6%></td><td><%=result6%></td><td><img src="mimage.jsp?id=<%=id6%>" width="100px" height="50px"></td><td><a href="accept.jsp?id=<%=id6%>"><%=approve%></a></td></tr>
